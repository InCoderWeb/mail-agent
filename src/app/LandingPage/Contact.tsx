...
//   return (
//     <section id="contact" className="relative z-0 mt-[400px]">
//       <div className="min-h-screen bg-[#1a1a1a] text-white flex items-center justify-center px-4">
//         <div className="max-w-6xl w-full bg-[#101010] rounded-xl p-10 md:flex md:justify-between">
//           {/* Left Form */}
//           <div className="md:w-1/2 mb-10 md:mb-0">
//             <h1 className="text-3xl md:text-4xl font-semibold mb-2">
//               Let’s <span className="text-[#810CAB]">create</span> something{" "}
//               <br />
//               remarkable <span className="text-[#810CAB]">together.</span>
//             </h1>
...
//               <button
//                 type="submit"
//                 className="bg-[#810CAB] hover:bg-[#a14ddb] transition text-white font-medium px-6 py-3 rounded-full"
//               >
...
//               </h3>
//               <a
//                 href="mailto:tanya@emailagent.ai"
//                 className="text-[#810CAB] hover:underline"
//               >
//                 EmailAgent@emailagent.ai
//               </a>
//             </div>
...
//                 />
//                 <img
//                   src="https://img.icons8.com/?size=100&id=9xygBPzKrg89&format=png&color=000000"
//                   alt=""
//                 />
//                 <img
//                   src="https://img.icons8.com/?size=100&id=g7P0iny5Rros&format=png&color=000000"
//                   alt=""
//                 />
//               </div>
//             </div>
